...
A weak stationary time series is a process which mean, variance and auto covariance do not change over time:
\small
{\color{blue}
...
To adapt VECM to be used with high frequency data, where the best parameters are updated when new data.
\end{block}

\begin{block}{Hypothesis}
An algorithm based on cointegration and high
...
To use VECM with high frequency data, where optimised parameters are obtained when new data. The optimisation was made in a distributed environment.
\end{frame}

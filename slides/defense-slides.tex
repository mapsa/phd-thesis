...
High Frequency Trading (HFT) is a technology that implements different trading strategies to buy or sell an asset using sophisticated infrastructure and high speed algorithms.
\end{alertblock}
...
\item Reduces the difference between buyers (bid) and sellers (ask) prices.
\end{itemize}
\end{exampleblock}
\end{column}
\begin{column}{0.5\textwidth}

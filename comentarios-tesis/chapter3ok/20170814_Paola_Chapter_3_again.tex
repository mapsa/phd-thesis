...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\red{\section{\Large AUGUST 19, 2017 -- Chapter 3 once again!}}
...
\myitem{P 37, formulae (3.3) and (3.6)}
...
\myitem{P 38, Complexity \dots of the hypothesis class + Fig. 3.1}
\mbox{}\newline
...
\vspace{2ex}
\red{{\em
``$f$ is a straight line as a classification model on points in a
two-dimensional plane (this is the model used by a perceptron). 
The line should separate positive data points from negative data points. 
There exist sets of 3 points that can indeed be shattered using this
model (any 3 points that are not collinear can be shattered). 
However, no set of 4 points can be shattered: by Radon's theorem,
any four points can be partitioned into two subsets with intersecting
convex hulls, so it is not possible to separate one of these two subsets
from the other. 

...
To determine parameter $\lambda$ is crucial for ridge regression, but the bias-variance tradeoff is not directly useful to determine it, since que don't know the data we want to predict. 

The two most  popular regularization methods are :
%%%% Agregar metodos del paper spectral cut-off y cross valid
\begin{itemize}

...
%reduce the expected prediction error by reducing variance (bias-variance trafeoff) considering a biased
%estimator. It is known that the prediction error is
%obtained as:
%
%\begin{equation}
% \label{eq:prederror}
